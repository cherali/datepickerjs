...
<template>
  <div :key="getDateRef()" style="display: inline-block; width: auto;" ref="containerRef">
    ...
    <div  style="width: 300px">
      <input type="text" :value="getDate()" @focus="() => setOpen(true)">
    </div>

    <div v-if="isOpen() && !isLoading()" style="display: flex; width: 300px; gap: 16px; flex-direction: row;">
      ...
      <div v-if="getMode() === 'day' && !isLoading()" style="flex: 1;">
        <div>
