...
function picker() {
  ...
  const createMarkup = () => {
    ...
    const selectedDateSize = getSelectedDates().size;
    ...
    input.type = "text";
    input.setAttribute("value", getFirstSelectedDate());

    const countSelected = document.createElement("span");
    countSelected.style.marginInlineStart = "8px";
    countSelected.innerHTML = "+" + (selectedDateSize - 1);

    const clearSelectionBtn = document.createElement("button");
    clearSelectionBtn.innerText = "clear selection";
    clearSelectionBtn.style.marginInlineStart = "8px";
    clearSelectionBtn.id = "clear-selection";
    ...
    if (selectedDateSize > 1) {
      content.insertAdjacentHTML("beforeend", countSelected.outerHTML);
    }
    content.insertAdjacentHTML("beforeend", clearSelectionBtn.outerHTML);
